...
using System.Text;
using Wox.Plugin.MigemoSearch.MigemoSearch.Exceptions;
using Wox.Plugin.MigemoSearch;
...
namespace Wox.Plugin.MigemoSearch.Everything
{
    ...
    {
        #region DllImport
        [DllImport(Main.EVERYTHING_DLL, CharSet = CharSet.Unicode)]
        private static extern int Everything_SetSearchW(string lpSearchString);
        [DllImport(Main.EVERYTHING_DLL)]
